...
public class Ball {
  ...
  /**
   * Used to reset the ball back to its initial position and stay there.
   */
  public void reset() {
  ...
  /**
   * gets the ball's speed in the x direction
   * @return the double of the ball's speed x component
   */
