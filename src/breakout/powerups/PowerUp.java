...
/**
 * This class is an abstract powerup. All powerups are circles with a color that drop down the
 * screen and do something on a game object (ball or paddle, currently).
 */
public abstract class PowerUp {

  private static final int dropSpeed = 1; //we left this due to the extendability of this in the future
  ...
  public PowerUp(Node blockSpawnedFrom) {
    ...
    this.displayCircle = new Circle(blockBounds.getCenterX(), blockBounds.getCenterY(),
        blockBounds.getWidth() / 10);///block.getHeight());
